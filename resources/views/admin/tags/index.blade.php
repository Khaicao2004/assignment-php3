        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('tags.create') }}" class="btn btn-primary mb-3">Thêm mới</a>
                </div>
                <div class="card-body">
                    <table id="example"
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <a href="{{ route('tags.show', $item->id) }}" class="btn btn-primary mx-2">Xem</a>
                                        <a href="{{ route('tags.edit', $item->id) }}" class="btn btn-warning me-2">Sửa</a>
